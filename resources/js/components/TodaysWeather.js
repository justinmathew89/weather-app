        ...
        return (
            <div className="my-4 overflow-hidden">
                ...
                <div className="float-left w-1/2">
                    <span className="text-4xl">{this.props.todaysWeather['currentTemperature']} <sup>o</sup>C<br /></span>
                    <span className="text-4xl">{this.props.todaysWeather['currentTemperatureFeelsLike']} <sup>o</sup>C<br /></span>
                </div>
            </div>
        )
    }
